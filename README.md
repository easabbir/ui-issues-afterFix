# Offerwall Remote App

This is the remote application for the Offerwall project. It is designed to be used as a microfrontend and can be consumed by a host application using Webpack Module Federation.
